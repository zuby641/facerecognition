...
<main className="pa4 black-80">
  <form className="measure ">
    ...
    <div className="">
      <input onClick={()=>props.RouterChange("Home")} className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib pointer" type="submit" value="Register"/>
    </div>
